...
print("This scrip trains on enterntainment and tests on healthcare")
...
#file = 'rich_data/hlt_pol_ent/hlt_pol_ent0.8.json'
...
X_train, y_train, X_test, y_test =  cross_splitter(df_ent_train, df_hlt_test,classes)
