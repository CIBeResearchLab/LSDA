...
if mode == 'in':
    x_s_token, x_t_token, y_train, x_s_test_token, x_t_test_token,  y_test, sentence_maxlen,target_maxlen= in_splitter(df, domains['ent'])
if mode == 'cross':
    x_s_token, x_t_token, y_train, x_s_test_token, x_t_test_token,y_test, sentence_maxlen,target_maxlen= cross_splitter(df, domains['ent'], domains['hlt'] )
